...
for N in N_values
    ...
    name = "Data/GridSearch/OBC/OBCGlaubGrid1000N"*string(N)*"beta"*string(beta)
    save_object(name, gap_all)
end

# N=9
# beta = 100
# name = "Data/GridSearch/GlaubGrid100N"*string(N)*"beta"*string(beta)
...
# name = "Figures/OBCgridG100N"*string(N)*"beta"*string(beta)*".png"
# plt.savefig(name)
# plt.show()