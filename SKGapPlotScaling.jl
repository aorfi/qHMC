...
# gapPer4 = load_object("Data/qHMC/alphaEtaParam/alpha1eta0.4beta6")
# gapPer1 = load_object("Data/qHMC/alphaEtaParam/alpha1eta0.1beta6")
...
# fit1 = curve_fit(model,log.(N_values),log.(gapPer1),p0)
# param1 = fit1.param
...
# plt.scatter(N_values, gapPer4, label = L"qHMC $\alpha = 1$ $\eta=0.4$")
