...
plt.xlabel(L"$\eta$")
ax2 = ax1.twinx()
ax1.plot(eta_values[2:end],scaleEx[2:end], color = "tab:blue")
...
# gap = load_object("Data/qHMC/alphaEtaParam/alpha0etaPI2+0.1beta6")
...
# label_scatter = L"$\alpha = 0$ $\eta = \pi/2 + 0.1$ $N^{b}$ b= "*string(scale)
...
# plt.grid("both","both")
# plt.legend()
# name = "Figures/Ising/qHMCScaling/alphaEtaParam/alpha0etaPI2.png"
# plt.savefig(name)
# plt.show()