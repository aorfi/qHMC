...
gap = load_object("Data/qHMC/alphaEtaParam/bestGapBeta6")
gap1 = load_object("Data/qHMC/alphaEtaParam/random0-10Beta6")
gap2 = load_object("Data/qHMC/alphaEtaParam/randomTriangleBeta6")
display(gap)
N_values = (5:10)
N_values_big = (5:15)
